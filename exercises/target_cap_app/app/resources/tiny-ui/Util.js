...
function openFirstDialog() {
  ...
  if (oFirstDialog) {
     ...
     oFirstDialog.addButton(new sap.ui.commons.Button({
         ...
         press: function() {
            var oData = {
               IM_COUNTRY : sap.ui.getCore().byId("name").getValue(),
               IM_CONTINENT : sap.ui.getCore().byId("partof").getValue()
             }
     
             let oPayload = {};
             oPayload.ValueFields = oData;

            var insertdata = JSON.stringify(oPayload);
