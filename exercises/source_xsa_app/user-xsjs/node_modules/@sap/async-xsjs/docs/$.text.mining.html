...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Namespace: mining</title>
    ...
    <link rel="canonical" href="$.text.mining.html">
</head>
<body>
<div id="main">
    <h1 class="page-title">Namespace: mining</h1>
    <section>
        <header>
            <h2>
                <span class="ancestors"><a href="$.html">$</a><a href="$.text.html">.text</a>.</span>
                mining
            </h2>
            <div class="class-description"><p class="message warning"><b>Caution</b><br>
        ...
        <article>
            <div class="container-overview">
                <div class="description">Namespace for Text Mining.
                    <p>
                        Text Mining provides functionality that can compare documents by examining the terms used within
                        them.
                    </p></div>
                <dl class="details">
                </dl>
            ...
            <dl>
                <dt><a href="$.text.mining.Session.html">Session</a></dt>
                <dd></dd>
            </dl>
        </article>
    </section>
