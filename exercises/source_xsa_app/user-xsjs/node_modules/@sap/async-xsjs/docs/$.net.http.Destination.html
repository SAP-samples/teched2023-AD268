...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: Destination</title>
    ...
    <link rel="canonical" href="$.net.http.Destination.html">
</head>
<body>
<div id="main">
    <h1 class="page-title">Class: Destination</h1>
    <section>
        <header>
            <h2>
        ...
        <article>
            <div class="container-overview">
                <dt>
                    <h4 class="name" id="Destination"><span class="type-signature"></span>new Destination<span
                            class="signature">()</span><span class="type-signature"></span></h4>
                </dt>
                <dd>
                    <div class="description">
                        HTTP(s) destination that holds metadata, for example: host, port, useSSL.
                        The destination can be retrieved from the database with <a
                            href="$.net.http.html#readDestination">$.net.http.readDestination</a>.
                    </div>
                    <dl class="details">
                    </dl>
                </dd>
