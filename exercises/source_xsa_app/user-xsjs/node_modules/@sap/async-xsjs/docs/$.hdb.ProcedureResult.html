...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: ProcedureResult</title>
    ...
    <link rel="canonical" href="$.hdb.ProcedureResult.html">
</head>
<body>
<div id="main">
    <h1 class="page-title">Class: ProcedureResult</h1>
    <section>
        <header>
            <h2>
            ...
            <div class="class-description">Represents the result of a stored procedure call.</div>
        </header>
        <article>
            <div class="container-overview">
                <dt>
                    <h4 class="name" id="ProcedureResult"><span class="type-signature"></span>new ProcedureResult<span
                            class="signature">()</span><span class="type-signature"></span></h4>
                </dt>
                <dd>
                    <div class="description">
                        The $.hdb.ProcedureResult object contains the output parameters and $.hdb.ResultSet objects
                        returned by a procedure call. Output parameters can be accessed by their name. The
                        $.hdb.ResultSet objects are stored in an array under the $resultSets property.
                    </div>
                    <dl class="details">
                    </dl>
                    <h5>Example</h5>
                    <pre class="prettyprint"><code>// Assuming procedure with signature 'DB_EXAMPLE'.icecream.shop::sell(IN flavor VARCHAR, IN quantity INTEGER, IN payment DECIMAL, OUT change DECIMAL)
var fnSell = <b>await </b>connection.loadProcedure('DB_EXAMPLE', 'icecream.shop::sell');

var result = <b>await </b>fnSell('CHOCOLATE', 3, 30.0);
...
for (var outputParam in result) {
    params += outputParam + ' ';
            ...
            <dl>
                <dt>
                    <h4 class="name" id="$resultSets"><span class="type-signature"></span>$resultSets<span
                            class="type-signature"> :Array.&lt;<a
                            href="$.hdb.ResultSet.html">$.hdb.ResultSet</a>></span></h4>
                </dt>
                <dd>
                    <div class="description">
                    ...
                    <ul>
                        <li>
                            <span class="param-type">Array.&lt;<a
                                    href="$.hdb.ResultSet.html">$.hdb.ResultSet</a>></span>
                        </li>
                    </ul>
                    <dl class="details">
                    </dl>
