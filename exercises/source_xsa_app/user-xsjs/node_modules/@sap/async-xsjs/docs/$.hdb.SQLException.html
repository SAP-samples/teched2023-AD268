...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: SQLException</title>
    ...
    <link rel="canonical" href="$.hdb.SQLException.html">
</head>
<body>
<div id="main">
    <h1 class="page-title">Class: SQLException</h1>
    <section>
        <header>
            <h2>
            ...
            <div class="class-description">$.hdb.SQLException an SQL error being thrown from $.hdb methods</div>
        </header>
        <article>
            <div class="container-overview">
                <dt>
                    <h4 class="name" id="SQLException"><span class="type-signature"></span>new SQLException<span
                            class="signature">()</span><span class="type-signature"></span></h4>
                </dt>
                <dd>
                    <div class="description">
                        This class does not really exist and is used solely for documentation purposes
                    </div>
                    <dl class="details">
                    </dl>
                </dd>
            ...
            <dl>
                <dt>
                    <h4 class="name" id="code"><span class="type-signature"></span>code<span class="type-signature"> :Number</span>
                    </h4>
                </dt>
                <dd>
                    <div class="description">
                        The SQL error code documented in the HANA SQL reference manual. 0 means an internal server
                        error.
                    </div>
                    <h5>Type:</h5>
                    <ul>
