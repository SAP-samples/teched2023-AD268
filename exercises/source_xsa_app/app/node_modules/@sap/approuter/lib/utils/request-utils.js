...
const axiosRequest = async (method, requestOptions) => {
  ...
  if (response && response.statusCode && (response.statusCode ===  401 || response.statusCode === 403) && requestOptions.headers.Authorization && requestOptions.headers.Authorization.startsWith('Bearer ')){
