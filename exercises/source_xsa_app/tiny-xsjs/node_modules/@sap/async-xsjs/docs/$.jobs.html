...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Namespace: jobs</title>
...
<body>
<div id="main">
    <h1 class="page-title">Namespace: jobs</h1>
    <section>
        <header>
            <h2>
        ...
        <article>
            <div class="container-overview">
                <div class="description">Namespace: jobs</div>
                <dl class="details">
                </dl>
            </div>
            <h3 class="subsection-title">Classes</h3>
            <dl>
                <dt><a href="$.jobs.Job.html">Job</a></dt>
                <dd></dd>
                <dt><a href="$.jobs.JobLog.html">JobLog</a></dt>
                <dd></dd>
                <dt><a href="$.jobs.JobSchedules.html">JobSchedules</a></dt>
                <dd></dd>
            </dl>
        </article>
    </section>
